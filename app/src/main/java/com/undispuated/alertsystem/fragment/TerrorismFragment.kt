 ...
 * Use the [TerrorismFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TerrorismFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_terrorism, container, false)
        viewModel = ViewModelProvider(this).get(ProfileViewModel::class.java)

        txtDetectedLoc = view.findViewById(R.id.detected_loc_terror)
        btnCancelAlert = view.findViewById(R.id.btnCancelTerror)
        btnOutOfEmergency = view.findViewById(R.id.btnOutOfEmergTerror)
    ...
    companion object {
         ...
         * @return A new instance of fragment TerrorismFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TerrorismFragment().apply {
