 ...
 * Use the [TheftFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TheftFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_theft, container, false)
        viewModel = ViewModelProvider(this).get(ProfileViewModel::class.java)

        txtDetectedLoc = view.findViewById(R.id.detected_loc_theft)
        btnCancelAlert = view.findViewById(R.id.btnCancelTheft)
        btnOutOfEmergency = view.findViewById(R.id.btnOutOfEmergTheft)
    ...
    companion object {
         ...
         * @return A new instance of fragment TheftFragment.
         */
